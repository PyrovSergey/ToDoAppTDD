...
class DetailViewControllerTests: XCTestCase {
    ...
    func setupTaskAndAppearanceTransition() {
        let coordinate = CLLocationCoordinate2D(latitude: 54.74801923, longitude: 56.011003876)
    ...
    func testSettingTaskSetsMapView() {
        ...
        XCTAssertEqual(sut.mapView.centerCoordinate.longitude, 56.011003876, accuracy: 0.001)
    }
